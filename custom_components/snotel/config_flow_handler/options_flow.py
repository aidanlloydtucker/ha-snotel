...
from custom_components.snotel.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class SnotelOptionsFlow(config_entries.OptionsFlow):
    """
