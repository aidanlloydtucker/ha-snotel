...
This guide will help you install and set up the Snotel custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/aidanlloydtucker/ha-snotel`
6. Set category to "Integration"
7. Click "Add"
8. Find "Snotel" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/aidanlloydtucker/ha-snotel/releases)
2. Extract the `snotel` folder from the archive
3. Copy it to `custom_components/snotel/` in your Home Assistant configuration directory
...
- [GitHub Discussions](https://github.com/aidanlloydtucker/ha-snotel/discussions)
