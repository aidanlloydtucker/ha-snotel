...
- **Title:** Snotel
- **Class prefix:** `Snotel`
- **Main code:** `custom_components/snotel/`
...
- `entity/` — Base entity class (`SnotelEntity`)
...
- Entity MRO: `(PlatformEntity, SnotelEntity)` — order matters
...
- Debug level: `custom_components.snotel: debug` in `config/configuration.yaml`
