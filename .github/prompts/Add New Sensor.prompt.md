...
- Create new sensor file in `custom_components/snotel/sensor/`
- Inherit from `SnotelEntity` and `SensorEntity`
...
class Snotel[SensorName]Sensor(
    SnotelEntity,
    SensorEntity,
):
...
- Entity: `custom_components/snotel/sensor/[sensor_name].py`
- Platform: `custom_components/snotel/sensor/__init__.py`
- Translations: `custom_components/snotel/translations/*.json`
