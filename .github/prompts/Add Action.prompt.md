...
**File:** `custom_components/snotel/services.yaml`
...
Create `custom_components/snotel/service_actions/[action_name].py`:

```python
"""[Action name] service action for Snotel."""
...
**File:** `custom_components/snotel/__init__.py`
...
**File:** `custom_components/snotel/const.py`
...
3. Find service action: `snotel.[action_name]`
...
- **Domain:** `snotel`
- **Service actions directory:** `custom_components/snotel/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/snotel/services.yaml` (legacy filename)
- **Icons:** `custom_components/snotel/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/snotel/translations/*.json` under `services` key (legacy)
