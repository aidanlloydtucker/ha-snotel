...
- Inherit from `SnotelEntity` and platform base class
...
- Entity: `custom_components/snotel/[platform]/[entity_name].py`
- Platform: `custom_components/snotel/[platform]/__init__.py`
