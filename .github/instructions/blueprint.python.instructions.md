...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Snotel`
...
- Inherit from both platform entity and `SnotelEntity` (order matters)
...
from custom_components.snotel.sensor import async_setup_entry
...
**Config entry data:** `entry_data: SnotelData = hass.data[DOMAIN][entry.entry_id]`
